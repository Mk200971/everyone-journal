        ...
        <div className="flex flex-col gap-4 sm:gap-6">
          ...
          <Card className="bg-white/10 dark:bg-black/20 backdrop-blur-lg border border-white/20 dark:border-white/10">
            <CardHeader className="pb-4 sm:pb-6">
              <CardTitle className="text-xl sm:text-2xl text-foreground text-center">Welcome Back</CardTitle>
                  ...
                  <div className="grid gap-2">
                    ...
                    <div className="text-right">
                      <Link
                        ...
                        className="text-sm text-teal-600 hover:text-teal-700 font-medium underline underline-offset-4 transition-colors"
                      >
                        Forgot password?
                      </Link>
                    </div>
